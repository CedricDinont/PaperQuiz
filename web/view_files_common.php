...
function showFile($dir, $file) {
    ...
    $types_fic = array(".jpg",".jpg.mmr_data",".jpg.omr1_data",".jpg.omr2_data",".jpg.omr3_data",".jpg_binarized.jpg",".jpg_corrected.jpg"
...
function getFile($dir, $file) {
    ...
    $types=array(".jpg",".jpg.omr1_data",".jpg.omr2_data",".jpg.omr3_data",".jpg_binarized.jpg",".jpg_corrected.jpg"
